...
export const metadata: Metadata = createMetadata({
  ...
  description: 'Learn about ChokhiYatra - your trusted travel partner. Explore the world with expert guidance and discover our mission to make homes & businesses sparkle.',
  keywords: ['about', 'travel agency', 'company', 'team', 'ChokhiYatra', 'travel expert', 'tour guide'],
  url: '/about',
});
  ...
  return (
    <PageLayout>
      <Breadcrumb title="About Us" />
              ...
              <div className="row align-items-end">
                ...
                <div className="col-xl-4">
                  <div className="about-wrapper" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
                    <p className="about-paragraph tw-text-lg fw-medium tw-mb-6">Touriex hires great people from a
                      Real Transport founded of backgrounds, which simply makes stronger and we couldn't be
                      prouder elevating your optimizing Inc was</p>
                    <div className="about-button">
                      <a className="primary-btn bg-main-two-600 text-main-600 tw-py-4 tw-px-8 fs-15 text-uppercase fw-bold font-heading tw-gap-2 d-inline-flex align-items-center tw-rounded-4xl"
                        href="about.html">explore more <i className="ph ph-arrow-up-right"></i></a>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div className="col-xl-6 col-lg-7">
                    <div className="section-wrapper tw-mb-14" data-aos="fade-up" data-aos-duration="1000"
                      ...
                      <h6 className="section-subtitle font-sofia tw-text-2xl fw-normal tw-mb-4">Populer
                        Destination</h6>
                      <h2 className="section-title fw-normal tw-mb-7 char-animation">The facts are the facts</h2>
                      <p className="tw-text-lg fw-normal">The facts are the facts communication and utilizes
                        cutting edge logistic planning to get your shipment completed on time. itself
                        founded of backgrounds, which simply.</p>
                    </div>
                  </div>
                  <div className="col-xl-3 col-lg-3">
                    <div className="destination-button common-hover-yellow d-flex justify-content-end flex-wrap"
                      ...
                      <a className="primary-btn bg-main-600 text-white tw-py-4 tw-px-8 fs-15 text-uppercase fw-bold font-heading tw-gap-2 d-inline-flex align-items-center tw-rounded-4xl"
                        href="#">explore more <i className="ph ph-arrow-up-right"></i></a>
                    </div>
                  </div>
                </div>
                <div className="row">
                        ...
                        <div className="panels-container d-flex tw-gap-7">
                          ...
                          <div className="panel">
                            <div className="destination-wrap-frist-chile">
                              <span className="destination-text text-uppercase tw-text-lg fw-medium">(Core
                                features)</span>
                            </div>
                          </div>
                          {/* item 2 */}
                          <div className="panel">
                            <div className="destination-wrap">
                              <div className="destination-icon">
                                <span><img src="assets/images/icon/destination-icon2.svg"
                                  alt="icon" /></span>
                              </div>
                              <div className="destination-content">
                                <h6 className="tw-text-2xl fw-normal">Best Pricing <br />
                                  Garuentee</h6>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="panel">
                            <div className="destination-wrap">
                              <div className="destination-icon">
                                <span><img src="assets/images/icon/destination-icon3.svg"
                                  alt="icon" /></span>
                              </div>
                              <div className="destination-content">
                                <h6 className="tw-text-2xl fw-normal">24/7 <br />
                                  Support</h6>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="panel">
                            <div className="destination-wrap">
                              <div className="destination-icon">
                                <span><img src="assets/images/icon/destination-icon4.svg"
                                  alt="icon" /></span>
                              </div>
                              <div className="destination-content">
                                <h6 className="tw-text-2xl fw-normal">Safety & <br />
                                  Privacy</h6>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="panel">
                            <div className="destination-wrap">
                              <div className="destination-icon">
                                <span><img src="assets/images/icon/destination-icon5.svg"
                                  alt="icon" /></span>
                              </div>
                              <div className="destination-content">
                                <h6 className="tw-text-2xl fw-normal">Hygine food <br />
                                  & desert</h6>
                              </div>
                            </div>
                          </div>
              ...
              <div className="row justify-content-center">
                <div className="col-xl-10">
                  <div className="ChokhiYatra-content tp-cursor-point-area text-center tw-mb-14">
                    <h6 className="ChokhiYatra-text fw-normal">we <span className="fw-bold">believe</span> that a clean
                      space is happy space. Founded in <span className="fw-bold">1998</span>, our mission is to
                      make homes & businesses sparkle while...</h6>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div className="swiper-wrapper d-flex align-items-center">
                      ...
                      <div className="gallery-two-wrapper swiper-slide">
                        <div className="gallery-two-thumb">
                          <img className="tw-rounded-xl" src="assets/images/gallery/gallery-two-thumb1.jpg"
                            alt="thumb" />
                        </div>
                      </div>
                      ...
                      <div className="gallery-two-wrapper swiper-slide">
                        <div className="gallery-two-thumb">
                          <img className="tw-rounded-xl" src="assets/images/gallery/gallery-two-thumb2.jpg"
                            alt="thumb" />
                        </div>
                      </div>
                      ...
                      <div className="gallery-two-wrapper swiper-slide">
                        <div className="gallery-two-thumb">
                          <img className="tw-rounded-xl" src="assets/images/gallery/gallery-two-thumb3.jpg"
                            alt="thumb" />
                        </div>
                      </div>
                      ...
                      <div className="gallery-two-wrapper swiper-slide">
                        <div className="gallery-two-thumb">
                          <img className="tw-rounded-xl" src="assets/images/gallery/gallery-two-thumb4.jpg"
                            alt="thumb" />
                        </div>
                      </div>
                      ...
                      <div className="gallery-two-wrapper swiper-slide">
                        <div className="gallery-two-thumb">
                          <img className="tw-rounded-xl" src="assets/images/gallery/gallery-two-thumb5.jpg"
                            alt="thumb" />
                        </div>
                      </div>
            ...
            <div className="container">
              <div className="row align-items-center justify-content-between">
                <div className="col-xl-6 col-lg-7">
                  <div className="section-wrapper tw-mb-14" data-aos="fade-up" data-aos-duration="1000"
                    data-aos-delay="200">
                    <h6 className="section-subtitle font-sofia tw-text-2xl fw-normal tw-mb-4">Team Members</h6>
                    <h2 className="section-title fw-normal tw-mb-7 char-animation">Meet the Explorers</h2>
                    <p className="tw-text-lg fw-normal">The facts are the facts communication and utilizes cutting
                      edge logistic planning to get your shipment completed on time. itself founded of
                      backgrounds, which simply.</p>
                  </div>
                </div>
                <div className="col-xl-3 col-lg-3">
                  <div className="destination-button common-hover-yellow d-flex justify-content-end flex-wrap"
          ...
          {/* Counter Section */}
          <section className="counter-three-area py-140">
            <div className="container">
              <div className="row justify-content-center">
                <div className="col-xl-10">
                  <div className="row">
                    <div className="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                      <div className="counter-wrap text-center tw-mb-8" data-aos="fade-up"
                        data-aos-duration="1000" data-aos-delay="200">
                        <div className="counter-content">
                          <h2 className="counter-title counter-two-title counter-three-title fw-semibold">
                            <span className="purecounter" data-purecounter-duration="1"
                              data-purecounter-end="145"></span>
                          </h2>
                          <p
                            className="counter-paragraph counter-two-paragraph tw-text-3xl tw-text-505 fw-bold text-capitalize">
                            Travel Tales</p>
                        </div>
                      </div>
                    </div>
              ...
              <div className="row">
                <div className="col-xl-5">
                  <div className="section-wrapper tw-mb-14 faq-sticky">
                    <h6 className="section-subtitle font-sofia tw-text-2xl fw-normal tw-mb-4">Populer Destination
                    </h6>
                    <h2 className="section-title fw-normal tw-mb-7 char-animation"> Frequently
                      ask Questions</h2>
                    <p className="section-paragraph tw-text-lg fw-normal">communication and utilizes cutting edge
                      logistic planning
          ...
          {/* Feature/Popular Package Section */}
          <section className="feature-area py-140 position-relative z-1">
            <div className="container">
              <div className="row justify-content-center">
                <div className="col-xl-7">
                  <div className="section-wrapper text-center tw-mb-10" data-aos="fade-up" data-aos-duration="1000"
                    data-aos-delay="200">
                    <h6 className="section-subtitle font-sofia tw-text-2xl fw-normal tw-mb-4">Populer package</h6>
                    <h2 className="section-title fw-normal tw-mb-7 char-animation">Explore Our Popular Picks Trusted
                      by Thousands</h2>
                    <p className="section-paragraph tw-text-lg fw-normal">communication and utilizes cutting edge
                      logistic planning to get your shipment completed
                  ...
                  <div className="feature-slider">
                    <div className="feature-active swiper-container">
                      <div className="swiper-wrapper">
                        {/* slide 1 */}
                        <div className="feature-wrapper tw-mb-8 tw-rounded-xl overflow-hidden  swiper-slide"
                          data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                          <div className="feature-thumb position-relative z-1 tw-rounded-xl">
                            <img className="w-100 tw-rounded-2xl"
                              src="assets/images/feature/feature-thumb1.jpg" alt="thumb" />
                            <div
                              className="feature-wrap position-absolute start-0 bottom-0 z-1 w-100 tw-px-5 tw-mb-10">
                              <div className="feature-top tw-pb-4 tw-mb-3">
                                <h6
                                  className="text-white font-body fw-medium tw-text-xs d-inline-flex tw-gap-2 tw-mb-3">
                                  <span><img src="assets/images/icon/feature-location.svg"
                                    alt="" /></span> Lombok, Indonesia
                                </h6>
                                <h4 className="text-white text-capitalize tw-text-xl">Weekend Wanderer
                                </h4>
                              </div>
                              <div className="d-flex align-items-center justify-content-between">
                                <span className="text-white fw-medium tw-text-sm">7 Days . 6
                                  Nights</span>
                        ...
                        <div className="feature-wrapper tw-mb-8 tw-rounded-xl overflow-hidden swiper-slide"
                          ...
                          <div className="feature-thumb position-relative z-1 tw-rounded-xl">
                            <img className="w-100 tw-rounded-2xl"
                              src="assets/images/feature/feature-thumb2.jpg" alt="thumb" />
                            <div
                              className="feature-wrap position-absolute start-0 bottom-0 z-1 w-100 tw-px-5 tw-mb-10">
                              <div className="feature-top tw-pb-4 tw-mb-3">
                                <h6
                        ...
                        <div className="feature-wrapper tw-mb-8 tw-rounded-xl overflow-hidden swiper-slide"
                          ...
                          <div className="feature-thumb position-relative z-1 tw-rounded-xl">
                            <img className="w-100 tw-rounded-2xl"
                              src="assets/images/feature/feature-thumb3.jpg" alt="thumb" />
                            <div
                              className="feature-wrap position-absolute start-0 bottom-0 z-1 w-100 tw-px-5 tw-mb-10">
                              <div className="feature-top tw-pb-4 tw-mb-3">
                                <h6
                        ...
                        <div className="feature-wrapper tw-mb-8 tw-rounded-xl overflow-hidden swiper-slide"
                          ...
                          <div className="feature-thumb position-relative z-1 tw-rounded-xl">
                            <img className="w-100 tw-rounded-2xl"
                              src="assets/images/feature/feature-thumb4.jpg" alt="thumb" />
                            <div
                              className="feature-wrap position-absolute start-0 bottom-0 z-1 w-100 tw-px-5 tw-mb-10">
                              <div className="feature-top tw-pb-4 tw-mb-3">
                                <h6
              ...
              <div className="row">
                <div className="feature-button common-hover-yellow text-center tw-mt-3">
                  <a className="primary-btn bg-main-600 text-white tw-py-4 tw-px-8 fs-15 text-uppercase fw-bold font-heading tw-gap-2 d-inline-flex align-items-center tw-rounded-4xl"
                    href="contact.html">explore packge <i className="ph ph-arrow-up-right"></i></a>
                </div>
              </div>
            </div>
